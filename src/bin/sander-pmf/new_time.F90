...
#  include "new_time.h"
   _REAL_ tim
   integer istart
#ifdef API /* Disable timing for the API */
   return
#endif
   call wallclock(tim)
...
#  include "new_time.h"
   _REAL_ tim
   integer istop
#ifdef API /* Disable timing for API */
   return
#endif
   call wallclock(tim)
...
#ifdef API /* Disable timers for API */
   return
#endif
   ! get the max level
...
#ifndef API /* Disable timers in API */
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
